...
5. Copy `apps/web/.env.development.example` to `apps/web/.env.local`
6. Copy `apps/desktop/.env.local.example` to `apps/desktop/.env.local`
7. In `apps/api/.env`, set:
...
8. Install dependencies from the root:
